...
public class Main {
	...
	public static CenterAndSizeInterface centerSize = (JFrame frm) -> {
	    /*
	...
	public static JFrameInterface jInt = (JFrame frm, int onExit, String label) -> {
		// this will center and size the JFrame on screen
		// it will have a height and width of half the screen
		// calling the converted lambda block expression
		centerSize.centerAndSizeJFrameOnScreen(frm);
	...
	public static void main(String args[]) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			...
			JFrame frm;
			public void run() {
				demo = new SwingDemo("Centered JFrame Using Lambda Expressions!");
				frm = demo.getFrame();
				// assigning the lambda block expression
				frm = jInt.setFrameStuff(frm, JFrame.EXIT_ON_CLOSE, "My label in a centered JFrame");
				frm.setVisible(true);
			}
		});
	}
