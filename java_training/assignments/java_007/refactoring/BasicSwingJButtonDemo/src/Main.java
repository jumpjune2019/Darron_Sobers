...
public class Main {
	...
	public static CenterAndSizeInterface c = (JFrame frm, int width, int height) -> {
	...
	public static SetFrameStuffInterface s = (frm, onExit, width, height) -> {
		...
		bd.setBtns.setButtons(panel1, "First", "Second", "You Pressed First", "You Pressed Second");
		ButtonDemo bd2 = new ButtonDemo();
		bd2.setBtns.setButtons(panel2, "Up", "Down", "Going Up!", "Going Down!");
