...
public class Main {
	...
	// converted method into a block lambda expression
	static BasicSwingInterface1 swingDemo1 = (frm, width, height, onExit, label) -> {
	...
	public static void main(String args[]) {
		...
		*/
		...
		SwingUtilities.invokeLater(new Runnable() {
			...
			JFrame frm;
			public void run() {
				demo = new SwingDemo("Lambda Demo 1");
				frm = demo.getFrame();
				frm = swingDemo1.setFrameStuff(frm, 375, 100, JFrame.EXIT_ON_CLOSE, "I know how to use Lambdas!");
				frm.setVisible(true);
			}
		});
	}
